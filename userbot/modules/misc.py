...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan DHAN-UBOT....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`DHAN-UBOT Telah Dinonaktifkan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting DHAN-UBOT...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`DHAN-UBOT Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[DHAN-UBOT Repo](https://github.com/ramadhan73/DHAN-UBOT/blob/DHAN-UBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**╭✠╼━━━━━━❖━━━━━━━✠╮**\n             [{REPO_NAME}](https://github.com/ramadhan73/DHAN-UBOT)\n╰✠╼━━━━━━❖━━━━━━━✠╯\n•PEMILIK         : [𝐎𝐖𝐍𝐄𝐑]({OWNER_BOT})\n•CHANNEL      : [𝐈𝐍𝐅𝐎](t.me/gksukaribettt)\n•GROUP           : [𝐆𝐑𝐎𝐔𝐏](t.me/fuckinglovesex)\n•INSTAGRAM  :  [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE})"
    )
